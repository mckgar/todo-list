...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n}\n\n#content {\n  min-height: 100vh;\n  display: grid;\n  grid-template-columns: 1fr 5fr;\n}\n\n#sidebar {\n  border-right: 2px solid black;\n  box-shadow: 7px 0px 0px 0px rgba(0,0,0,0.2);\n\n  display: grid;\n  grid-template-rows: 2rem 1fr;\n  gap: 3rem;\n  padding: 2rem;\n}\n\n.link {\n  cursor: pointer;\n}\n\n.link + .link {\n  margin-top: 1.3rem;\n}\n\n#main {\n  grid-column: 2;\n  margin: 1rem;\n  display: grid;\n  grid-template-columns: 1fr 1fr 0.24fr;\n  grid-template-rows: 2rem 1fr;\n  gap: 1rem;\n}\n\n.title,\n#edit-title {\n  grid-column: 1;\n  grid-row: 1;\n}\n\n.return {\n  grid-column: -2;\n  grid-row: 1;\n  justify-self: end;\n\n  cursor: pointer;\n}\n\n.projects {\n  grid-row: 2;\n  grid-column: 1 / -1;\n  display: grid;\n  grid-template-columns: repeat(auto-fit, 18rem);\n  grid-auto-rows: 9rem;\n  gap: 1rem;\n}\n\n.card {\n  border: 1px solid black;\n  box-shadow: 5px 5px 0px 0px rgba(0,0,0,0.2);\n  padding: 0.5rem 2rem;\n\n  cursor: pointer;\n}\n\n.add,\n.editor {\n  font-size: 2.5rem;\n  height: 2.5rem;\n  width: 2.5rem;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n\n  cursor: pointer;\n}\n\n.add {\n  align-self: center;\n  justify-self: center;\n  border: 2px dashed black;\n  width: 100%;\n  height: 100%;\n}\n.card.project {\n  position: relative;\n}\n\n.project .description {\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  overflow: hidden;\n}\n\n.project .project-delete,\n.project .project-edit,\n.project .project-save {\n  font-size: 1.5rem;\n  width: 1.5rem;\n  height: 1.5rem;\n  position: absolute;\n}\n\n.project-delete {\n  right: 0.5rem;\n  bottom: 0.5rem;\n}\n\n.project-edit,\n.project-save {\n  right: 2.5rem;\n  bottom: 0.5rem;\n}\n\n.project #edit-title {\n  margin-bottom: 0.5rem;\n}\n\ntextarea {\n  width: 100%;\n}\n\n#project-edit,\n#project-save {\n  position: fixed;\n  bottom: 4rem;\n  right: 1rem;\n\n  font-size: 2.5rem;\n}\n\n#project-delete {\n  position: fixed;\n  bottom: 1rem;\n  right: 1rem;\n\n  font-size: 2.5rem;\n}\n\n.project-info,\n.notes {\n  grid-column: 1 / -2;\n  grid-row: 2;\n\n  display: grid;\n  grid-template-rows: repeat(50, auto) 1fr;\n  gap: 0.5rem;\n}\n\n.project-info .description,\n.project-info #edit-description {\n  grid-row: 1;\n}\n\n.todo {\n  display: grid;\n  grid-template-columns: 1fr 1fr 0.5fr 1fr 2rem;\n  grid-template-rows: 2rem;\n  gap: 0.25rem;\n  align-items: center;\n}\n\n.type,\n#edit-type {\n  grid-column: 2;\n  grid-row: 1;\n}\n\n.priority,\n#edit-priority {\n  grid-column: 3;\n  grid-row: 1;\n}\n\n.priority::before,\n#priority::before {\n  content: \"Priority: \";\n}\n\n.due-date,\n#due-date {\n  grid-column: 4;\n  grid-row: 1;\n}\n\n.due-date::before {\n  content: \"Due: \";\n}\n\n.card .status {\n  grid-column: 5;\n  grid-row: 1;\n\n  font-size: 1.8rem;\n  height: 2rem;\n  width: 2rem;\n  justify-self: end;\n}\n\n.status.false {\n  color: rgb(128, 128, 128, 0.5)\n}\n\n.status.true {\n  color: green;\n}\n\n.todo .description,\n.todo #edit-description,\n.todo textarea {\n  grid-column: 1 / 3;\n  grid-row: 2;\n}\n\n.todo .checklist {\n  grid-column: 3 / 6;\n  grid-row: 2;\n}\n\n.list-name.true {\n  color: green;\n}\n\n.list-item {\n  display: flex;\n  justify-content: space-between;\n}\n\n.add-checklist-item {\n  text-align: center;\n  border: 1px solid black;\n}\n\n.todo .buttons,\n.note .buttons {\n  grid-column: 1;\n  grid-row: 3;\n}\n\n.buttons {\n  display: grid;\n  grid-template-columns: 2rem 2rem;\n  gap: 0.5rem;\n}\n\n.list-item .buttons {\n  display: grid;\n  grid-template-columns: 1.5rem 1.5rem;\n  gap: 0.2rem;\n}\n\n.note-edit,\n#note-save,\n.todo-edit,\n#todo-save,\n.checklist-edit,\n#checklist-save {\n  grid-column: 1;\n  grid-row: 1;\n}\n\n.note-delete,\n.todo-delete,\n.checklist-delete {\n  grid-column: 2;\n}\n\n.buttons .editor {\n  font-size: 2rem;\n  height: 2rem;\n  width: 2rem;\n}\n\n.list-item .buttons .editor {\n  font-size: 1.5rem;\n  height: 1.5rem;\n  width: 1.5rem;\n}\n\n.note-delete:hover,\n.todo-delete:hover,\n.checklist-delete:hover,\n.project-delete:hover,\n#project-delete:hover {\n  color: red;\n}\n\n.notes {\n  margin-right: 3.5rem;\n}\n\n.note {\n  display: grid;\n  grid-template-rows: 2rem;\n  gap: 0.25rem;\n}\n\n.note .description,\n.note .edit-description {\n  grid-row: 2;\n}\n\n/* Material icon css */\n\n.material-symbols-outlined {\n  font-variation-settings:\n  'FILL' 0,\n  'wght' 400,\n  'GRAD' 0,\n  'opsz' 48;\n  text-align: center;\n\n  -moz-user-select: none;\n  -webkit-user-select: none;\n  -ms-user-select: none;\n  user-select: none;\n}", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,SAAS;EACT,UAAU;EACV,sBAAsB;AACxB;;AAEA;EACE,iBAAiB;EACjB,aAAa;EACb,8BAA8B;AAChC;;AAEA;EACE,6BAA6B;EAC7B,2CAA2C;;EAE3C,aAAa;EACb,4BAA4B;EAC5B,SAAS;EACT,aAAa;AACf;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,kBAAkB;AACpB;;AAEA;EACE,cAAc;EACd,YAAY;EACZ,aAAa;EACb,qCAAqC;EACrC,4BAA4B;EAC5B,SAAS;AACX;;AAEA;;EAEE,cAAc;EACd,WAAW;AACb;;AAEA;EACE,eAAe;EACf,WAAW;EACX,iBAAiB;;EAEjB,eAAe;AACjB;;AAEA;EACE,WAAW;EACX,mBAAmB;EACnB,aAAa;EACb,8CAA8C;EAC9C,oBAAoB;EACpB,SAAS;AACX;;AAEA;EACE,uBAAuB;EACvB,2CAA2C;EAC3C,oBAAoB;;EAEpB,eAAe;AACjB;;AAEA;;EAEE,iBAAiB;EACjB,cAAc;EACd,aAAa;EACb,aAAa;EACb,mBAAmB;EACnB,uBAAuB;;EAEvB,eAAe;AACjB;;AAEA;EACE,kBAAkB;EAClB,oBAAoB;EACpB,wBAAwB;EACxB,WAAW;EACX,YAAY;AACd;AACA;EACE,kBAAkB;AACpB;;AAEA;EACE,uBAAuB;EACvB,mBAAmB;EACnB,gBAAgB;AAClB;;AAEA;;;EAGE,iBAAiB;EACjB,aAAa;EACb,cAAc;EACd,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,cAAc;AAChB;;AAEA;;EAEE,aAAa;EACb,cAAc;AAChB;;AAEA;EACE,qBAAqB;AACvB;;AAEA;EACE,WAAW;AACb;;AAEA;;EAEE,eAAe;EACf,YAAY;EACZ,WAAW;;EAEX,iBAAiB;AACnB;;AAEA;EACE,eAAe;EACf,YAAY;EACZ,WAAW;;EAEX,iBAAiB;AACnB;;AAEA;;EAEE,mBAAmB;EACnB,WAAW;;EAEX,aAAa;EACb,wCAAwC;EACxC,WAAW;AACb;;AAEA;;EAEE,WAAW;AACb;;AAEA;EACE,aAAa;EACb,6CAA6C;EAC7C,wBAAwB;EACxB,YAAY;EACZ,mBAAmB;AACrB;;AAEA;;EAEE,cAAc;EACd,WAAW;AACb;;AAEA;;EAEE,cAAc;EACd,WAAW;AACb;;AAEA;;EAEE,qBAAqB;AACvB;;AAEA;;EAEE,cAAc;EACd,WAAW;AACb;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,cAAc;EACd,WAAW;;EAEX,iBAAiB;EACjB,YAAY;EACZ,WAAW;EACX,iBAAiB;AACnB;;AAEA;EACE;AACF;;AAEA;EACE,YAAY;AACd;;AAEA;;;EAGE,kBAAkB;EAClB,WAAW;AACb;;AAEA;EACE,kBAAkB;EAClB,WAAW;AACb;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,aAAa;EACb,8BAA8B;AAChC;;AAEA;EACE,kBAAkB;EAClB,uBAAuB;AACzB;;AAEA;;EAEE,cAAc;EACd,WAAW;AACb;;AAEA;EACE,aAAa;EACb,gCAAgC;EAChC,WAAW;AACb;;AAEA;EACE,aAAa;EACb,oCAAoC;EACpC,WAAW;AACb;;AAEA;;;;;;EAME,cAAc;EACd,WAAW;AACb;;AAEA;;;EAGE,cAAc;AAChB;;AAEA;EACE,eAAe;EACf,YAAY;EACZ,WAAW;AACb;;AAEA;EACE,iBAAiB;EACjB,cAAc;EACd,aAAa;AACf;;AAEA;;;;;EAKE,UAAU;AACZ;;AAEA;EACE,oBAAoB;AACtB;;AAEA;EACE,aAAa;EACb,wBAAwB;EACxB,YAAY;AACd;;AAEA;;EAEE,WAAW;AACb;;AAEA,sBAAsB;;AAEtB;EACE;;;;WAIS;EACT,kBAAkB;;EAElB,sBAAsB;EACtB,yBAAyB;EACzB,qBAAqB;EACrB,iBAAiB;AACnB","sourcesContent":["* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n}\n\n#content {\n  min-height: 100vh;\n  display: grid;\n  grid-template-columns: 1fr 5fr;\n}\n\n#sidebar {\n  border-right: 2px solid black;\n  box-shadow: 7px 0px 0px 0px rgba(0,0,0,0.2);\n\n  display: grid;\n  grid-template-rows: 2rem 1fr;\n  gap: 3rem;\n  padding: 2rem;\n}\n\n.link {\n  cursor: pointer;\n}\n\n.link + .link {\n  margin-top: 1.3rem;\n}\n\n#main {\n  grid-column: 2;\n  margin: 1rem;\n  display: grid;\n  grid-template-columns: 1fr 1fr 0.24fr;\n  grid-template-rows: 2rem 1fr;\n  gap: 1rem;\n}\n\n.title,\n#edit-title {\n  grid-column: 1;\n  grid-row: 1;\n}\n\n.return {\n  grid-column: -2;\n  grid-row: 1;\n  justify-self: end;\n\n  cursor: pointer;\n}\n\n.projects {\n  grid-row: 2;\n  grid-column: 1 / -1;\n  display: grid;\n  grid-template-columns: repeat(auto-fit, 18rem);\n  grid-auto-rows: 9rem;\n  gap: 1rem;\n}\n\n.card {\n  border: 1px solid black;\n  box-shadow: 5px 5px 0px 0px rgba(0,0,0,0.2);\n  padding: 0.5rem 2rem;\n\n  cursor: pointer;\n}\n\n.add,\n.editor {\n  font-size: 2.5rem;\n  height: 2.5rem;\n  width: 2.5rem;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n\n  cursor: pointer;\n}\n\n.add {\n  align-self: center;\n  justify-self: center;\n  border: 2px dashed black;\n  width: 100%;\n  height: 100%;\n}\n.card.project {\n  position: relative;\n}\n\n.project .description {\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  overflow: hidden;\n}\n\n.project .project-delete,\n.project .project-edit,\n.project .project-save {\n  font-size: 1.5rem;\n  width: 1.5rem;\n  height: 1.5rem;\n  position: absolute;\n}\n\n.project-delete {\n  right: 0.5rem;\n  bottom: 0.5rem;\n}\n\n.project-edit,\n.project-save {\n  right: 2.5rem;\n  bottom: 0.5rem;\n}\n\n.project #edit-title {\n  margin-bottom: 0.5rem;\n}\n\ntextarea {\n  width: 100%;\n}\n\n#project-edit,\n#project-save {\n  position: fixed;\n  bottom: 4rem;\n  right: 1rem;\n\n  font-size: 2.5rem;\n}\n\n#project-delete {\n  position: fixed;\n  bottom: 1rem;\n  right: 1rem;\n\n  font-size: 2.5rem;\n}\n\n.project-info,\n.notes {\n  grid-column: 1 / -2;\n  grid-row: 2;\n\n  display: grid;\n  grid-template-rows: repeat(50, auto) 1fr;\n  gap: 0.5rem;\n}\n\n.project-info .description,\n.project-info #edit-description {\n  grid-row: 1;\n}\n\n.todo {\n  display: grid;\n  grid-template-columns: 1fr 1fr 0.5fr 1fr 2rem;\n  grid-template-rows: 2rem;\n  gap: 0.25rem;\n  align-items: center;\n}\n\n.type,\n#edit-type {\n  grid-column: 2;\n  grid-row: 1;\n}\n\n.priority,\n#edit-priority {\n  grid-column: 3;\n  grid-row: 1;\n}\n\n.priority::before,\n#priority::before {\n  content: \"Priority: \";\n}\n\n.due-date,\n#due-date {\n  grid-column: 4;\n  grid-row: 1;\n}\n\n.due-date::before {\n  content: \"Due: \";\n}\n\n.card .status {\n  grid-column: 5;\n  grid-row: 1;\n\n  font-size: 1.8rem;\n  height: 2rem;\n  width: 2rem;\n  justify-self: end;\n}\n\n.status.false {\n  color: rgb(128, 128, 128, 0.5)\n}\n\n.status.true {\n  color: green;\n}\n\n.todo .description,\n.todo #edit-description,\n.todo textarea {\n  grid-column: 1 / 3;\n  grid-row: 2;\n}\n\n.todo .checklist {\n  grid-column: 3 / 6;\n  grid-row: 2;\n}\n\n.list-name.true {\n  color: green;\n}\n\n.list-item {\n  display: flex;\n  justify-content: space-between;\n}\n\n.add-checklist-item {\n  text-align: center;\n  border: 1px solid black;\n}\n\n.todo .buttons,\n.note .buttons {\n  grid-column: 1;\n  grid-row: 3;\n}\n\n.buttons {\n  display: grid;\n  grid-template-columns: 2rem 2rem;\n  gap: 0.5rem;\n}\n\n.list-item .buttons {\n  display: grid;\n  grid-template-columns: 1.5rem 1.5rem;\n  gap: 0.2rem;\n}\n\n.note-edit,\n#note-save,\n.todo-edit,\n#todo-save,\n.checklist-edit,\n#checklist-save {\n  grid-column: 1;\n  grid-row: 1;\n}\n\n.note-delete,\n.todo-delete,\n.checklist-delete {\n  grid-column: 2;\n}\n\n.buttons .editor {\n  font-size: 2rem;\n  height: 2rem;\n  width: 2rem;\n}\n\n.list-item .buttons .editor {\n  font-size: 1.5rem;\n  height: 1.5rem;\n  width: 1.5rem;\n}\n\n.note-delete:hover,\n.todo-delete:hover,\n.checklist-delete:hover,\n.project-delete:hover,\n#project-delete:hover {\n  color: red;\n}\n\n.notes {\n  margin-right: 3.5rem;\n}\n\n.note {\n  display: grid;\n  grid-template-rows: 2rem;\n  gap: 0.25rem;\n}\n\n.note .description,\n.note .edit-description {\n  grid-row: 2;\n}\n\n/* Material icon css */\n\n.material-symbols-outlined {\n  font-variation-settings:\n  'FILL' 0,\n  'wght' 400,\n  'GRAD' 0,\n  'opsz' 48;\n  text-align: center;\n\n  -moz-user-select: none;\n  -webkit-user-select: none;\n  -ms-user-select: none;\n  user-select: none;\n}"],"sourceRoot":""}]);
// Exports
...
const displayController = (() => {
  ...
  const createTodoCard = (todo, index) => {
    ...
    dueDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(todo.getDueDate()), 'MM/dd/yyyy');
...
function retrieveProjectList() {
  ...
  for (let i = 0; i < projectStorage.length; i += 1) {
    ...
    for (let j = 0; j < currentProject.todoList.length; j += 1) {
      ...
      todoItems.push((0,_todo_create__WEBPACK_IMPORTED_MODULE_1__.todo)(
        currentTodo.title,
    ...
    projectList.push((0,_todo_create__WEBPACK_IMPORTED_MODULE_1__.project)(currentProject.title, currentProject.description, todoItems));
  }
}
...
function retrieveNoteList() {
  ...
  for (let i = 0; i < noteStorage.length; i += 1) {
    ...
    noteList.push((0,_todo_create__WEBPACK_IMPORTED_MODULE_1__.note)(currentNote.title, currentNote.description));
  }
}
...
document.querySelector('#content').addEventListener('click', (e) => {
  if (e.target
    ...
    _display_controller__WEBPACK_IMPORTED_MODULE_2__["default"].projectFocus(
...
document.querySelector('#content').addEventListener('click', (e) => {
  if (e.target && e.target.matches('div.project-edit')) {
    _display_controller__WEBPACK_IMPORTED_MODULE_2__["default"].editProjectCard(
      projectList[e.target.classList[0]],
...
document.querySelector('#content').addEventListener('click', (e) => {
  if (e.target && e.target.matches('div.new-todo')) {
    const newTodo = (0,_todo_create__WEBPACK_IMPORTED_MODULE_1__.todo)('New Todo', 'Description', '2022-06-01', 5, 'Self-Improvement');
